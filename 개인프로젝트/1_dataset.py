...
# 클래스 정의
img_00 = ".\dataset\class_00" # 클래스 0번 (정상)
img_01 = ".\dataset\class_01" # 클래스 1번 ((결막염, 안구건조증 의심))
img_02 = ".\dataset\class_02" # 클래스 2번 (황달, 간질환)
img_03 = ".\dataset\class_03" # 클래스 3번 (백내장)

ver = 100 # (이미지 리사이즈 후) 세로 픽셀수
